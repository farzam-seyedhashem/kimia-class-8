        ...
        return (
            <div className="h-screen w-full bg-gray-50">
               <div className=" flex h-full container mx-auto items-center justify-center">
                <div className="border shadow-sm bg-white border-black border-opacity-10 py-8 px-6 w-full md:w-4/12 rounded-lg">
                    <div className="flex justify-center mb-8">
                        <Image layout={"fixed"} height={41} width={154} src="https://www.digikala.com/static/files/bc60cf05.svg"/>
                    </div>
                    <h1 className="font-bold text-lg mb-3">ورود و ثبت نام</h1>
                    <div>
                        <label className="text-gray-500 text-sm">شماره موبایل یا پست الکترونیک خود را وارد کنید</label>
                        <input
